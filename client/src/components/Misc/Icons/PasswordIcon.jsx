function PasswordIcon({repeat = false}) {
    return ( 
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" className={`form-icon ${repeat ? "repeat" : null}`}>
